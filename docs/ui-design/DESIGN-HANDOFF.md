# dd46ccac-966d-4a7d-90a4-2bf5108462ab implementation handoff

This archive is the source of truth for turning the design into production code. Start from `mr9k65ss-code.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `mr9k65ss-code.html`
...
- A single self-contained `mr9k65ss-code.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `mr9k65ss-code.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
- `mr9jndkp-01-FEATURES.md`
- `mr9jndkp-02-DATA-MODEL.md`
- `mr9k5xyc-DESIGN.md`

## Coding checklist for AI tools
1. Inspect `mr9k65ss-code.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
